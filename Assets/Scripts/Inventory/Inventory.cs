...
public class Inventory : MonoBehaviour, ISaveManager
{
    ...
    UI_EquipmentSlot[] equipmentItemSlot;
    UI_StatSlot[] statSlot;

    [Header("Items cooldowns")]
    ...
    public bool CanAddItem()
    {
        ...
        {
            PlayerManager.instance.player.fx.CreatePopUpText("Your inventory is full!");
            return false;
        }
    ...
    void AddToInventory(ItemData _item)
    {
    ...
    void AddToStash(ItemData _item)
    {
    ...
    public bool CanCraft(ItemDataEquipment _itemToCraft, List<InventoryItem> _requiredMaterials)
    {
        ...
        for (int i = 0; i < _requiredMaterials.Count; i++)
        {
            if (stashDictionary.TryGetValue(_requiredMaterials[i].data, out InventoryItem stashValue))
            {
                ...
                {
                    int amountOfMaterialToRemove = _requiredMaterials[i].stackSize;

                    while (amountOfMaterialToRemove > 0)
                    {
                        materialsToRemove.Add(stashValue);
                        amountOfMaterialToRemove--;
                    }
                }
            }
            else
    ...
    public void UseFlaskEffect()
    {
        ...
        if (canUseFlask)
        {
            ...
            PlayerManager.instance.player.fx.CreatePopUpText("Flask is on cooldown");
    }
