...
{
    [SerializeField] GameObject iceAndFirePref;
    [SerializeField] float xVelocity = 9f;
    ...
    public override void ExecuteEffect(Transform _respawnPosition)
    {
        ...
        if (thirdAttack)
        {
            GameObject newIceAndFire = Instantiate(iceAndFirePref, _respawnPosition.position, player.transform.rotation);
